...
@section('content')
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-semibold text-slate-800 dark:text-white">Add Category</h1>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 p-6 max-w-2xl">
        <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <p class="text-xs text-slate-400 mt-1">The URL-friendly version. Leave blank and we'll create it from the name.</p>
