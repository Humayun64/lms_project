    ...
    <div class="max-w-4xl mx-auto py-16 px-4">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="bg-slate-900 text-white px-8 py-6 flex items-center justify-between">
                ...
                <span class="bg-sky-500 text-white text-xs font-semibold px-3 py-1 rounded-full uppercase tracking-wide">
                    {{ Auth::user()->role }}
                </span>
            </div>
            ...
            <div class="px-8 py-8">
                ...
                <div class="mt-6 bg-sky-50 border border-sky-200 text-sky-800 rounded p-4 text-sm">
                    ✅ Authentication is working. This is a placeholder student dashboard —
